...
const PRODUCTS = {
  ...
  'print-carta-astral': {
    ...
    description: `Tu carta astral única, ilustrada a mano y enmarcada. Elige entre el diseño clásico o el diseño infantil — perfecta como regalo. Incluye todos los planetas, casas y aspectos de tu carta natal, con presentación premium lista para colgar.`,
    features: [
    ...
    requiresForm: true,
    designs: [
      { id: 'normal', name: 'Diseño clásico', image: 'images/productos/print-carta-astral-normal.jpg' },
      { id: 'infantil', name: 'Diseño infantil', image: 'images/productos/print-carta-astral-infantil.jpg' },
    ],
    formFields: [
